// AVL trees are height balancing binary search trees. AVL tree checks the height of the left and the
// right sub-trees and assures that the difference is not more thn 1. This difference is called the
// Balance Factor.
