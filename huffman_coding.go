// A Huffman code is a particular type of optiml prefix code that is commonly used for lossless
// data compression. The process of finding and/or using such a code proceeds by means of
// Huffman coding.
